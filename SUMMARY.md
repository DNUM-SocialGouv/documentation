...
- [Architecture](Architecture/README.MD)
  ...
  - [API](Architecture/api/README.md)
    - [API - Normes](Architecture/api/api-normes.md)
    - [API - Exposition](Architecture/api/api-exposition.md)
    - [API - Gateway](Architecture/api/api-gateway.md)
    - [API - Sécurisation](Architecture/api/api-securite.md)
  - [Data](Architecture/data/README.md)
    - [Data - Stockage](Architecture/data/data-stockage.md)
