...
| Qui peut publier et administrer une démarche ?                                                                      | Ensemble des organismes publics (AC, SD, etc.)                                                                                    | Ensemble des Ministères sociaux.<br>Autres organismes publics sur demande                   |
| SecNumCloud                                                                                                         | ✅                                                                                                                                | ❌                                                                                         |
| HDS                                                                                                                 | ❌                                                                                                                                | ✅                                                                                         |
| Connexion FranceConnect                                                                                             | ✅                                                                                                                                | ❌                                                                                         |
| Connexion ProConnect                                                                                                | ✅                                                                                                                                | ❌ (en cours)                                                                              |
| Champs spécifiques Min Sociaux                                                                                      | n/a                                                                                                                               | Champ NIR sécurisé<br>2 champs FINESS (avec lookup FINESS)<br>Champ RPPS (avec lookup RPPS) |
| Homologation RGS                                                                                                    | ✅                                                                                                                                | ✅                                                                                         |
| Rythme de déploiement                                                                                               | Hebdomadaire à quotidien<br>([liste des déploiements](https://github.com/demarche-numerique/demarche.numerique.gouv.fr/releases)) | Ponctuel. 24 mois de retard sur DN (2024-03-18)                                             |
...
* [Documentation complète Démarche Numérique](https://doc.demarche.numerique.gouv.fr/)
