...
| ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| <strong>Agent des Ministères Sociaux</strong><br><strong>Agent d'autres ministères</strong><br><strong>Service déconcentré (hors DDETS)</strong> | [ProConnect](authentification-proconnect.md)<br><em>(FI ProConnect des Ministères Sociaux)</em>                      |
| <strong>Service déconcentré DDETS</strong><br>@departement.gouv.fr                                                                               | [ProConnect Identité](authentification-proconnect.md)<br><em>(en attendant un FI ProConnect du MIOM)</em> |
| <strong>Collectivité territoriale</strong><br>(région, département, commune)                                                                     | [ProConnect Identité](authentification-proconnect.md)<br><em>(pas de FI ProConnect identifié à date)</em> |
| **Entreprise FR**                                                                                                                                | [ProConnect Identité](authentification-proconnect.md)                                                                |
| **Association avec SIRET**                                                                                                                       | [ProConnect Identité](authentification-proconnect.md)                                                                |
| **Entreprise étrangère, association sans SIRET**                                                                                                 | Solution spécifique (email, lien magique)                                                                            |
| **Particulier**                                                                                                                                  | Obligatoire : Solution spécifique (email, lien magique)<br>Facultatif : FranceConnect OU FranceConnect+              |
| <strong>Domaine DGEFP</strong><br>(entreprises, agents, associations)                                                                            | EFP Connect                                                                                                          |
| <strong>Domaine DGT</strong><br>(entreprises, agents, associations)                                                                              | [ProConnect](authentification-proconnect.md)                                                                         |
| **Professionnel de Santé**                                                                                                                       | [Pro Santé Connect](authentification-pro-sante-connect.md) (carte CPS / e-CPS)                                       |
| <strong>Domaine ATIH</strong>                                                                                                                    | [Plage / Pasrel](authentification-plage-pasrel.md)                                                                   |
