...
* L'application doit être livrée via des images Docker en suivant ces [recommandations internes DNUM](Recommandation%20de%20cre%CC%81ations%20d'images%20applicatives.pdf)
...
## Ressources
* Formation Kubernetes : [https://container.training](https://container.training)