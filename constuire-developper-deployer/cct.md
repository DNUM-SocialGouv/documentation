...
- **Documentation architecturale** : Documenter l'architecture via des diagrammes [C4](https://c4model.com/) (Context, Container, Component, Code) maintenus à jour pour les décisions structurantes, facilitant l'onboarding et les évolutions majeures.
