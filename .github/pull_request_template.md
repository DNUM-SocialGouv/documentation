...
- S'il s'agit d'un ajout d'une **nouvelle section** :
  - [ ] Est-ce que le fichier `SUMMARY.md` a bien été mis à jour avec la nouvelle section ?
    - _Pour afficher la section dans la table des matières_
...
- S'il s'agit d'un ajout d'une **nouvelle page** dans une **section existante**
  - [ ] Est-ce que le fichier `SUMMARY.md` a bien été mis à jour avec la nouvelle page ?
    - _Pour afficher la nouvelle page dans la section_
- S'il s'agit d'un ajout d'une **nouvelle page sans nouvelle section**
  - [ ] Est-ce que le fichier `SUMMARY.md` a bien été mis à jour ?
    - _Pour que la page soit accessible_
