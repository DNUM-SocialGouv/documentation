...
📄 _Doc. Cegedim :_ \*[**Démarrer avec l'Object Storage**](https://academy.cegedim.cloud/storage/object-storage/object-storage-get-started)\*\* · \*\*\*[_Limitations et bonnes pratiques_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/limitation-and-best-practices)
...
📄 \*Doc. Cegedim : \*\*\*[_Fonctionnalités de l'Object Storage_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features)

#### 3.1 Versioning de bucket — la protection de base

📄 \*Doc. Cegedim : \*\*\*[_Gérer le versioning d'un bucket_](https://academy.cegedim.cloud/storage/object-storage/object-storage-get-started/manage-versioning-in-bucket)
...
📄 \*Doc. Cegedim : \*\*\*[_Object Lock_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/object-lock)
...
📄 \*Doc. Cegedim : \*\*\*[_Bucket Lifecycle_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/bucket-lifecycle)
...
📄 _Doc. Cegedim :_ \*[**Bucket Policies**](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/bucket-policies)\*\* · \*\*\*[_Gérer les accès à un bucket_](https://academy.cegedim.cloud/storage/object-storage/object-storage-get-started/manage-bucket-access)
...
📄 \*Doc. Cegedim : \*\*\*[_Presigned URL_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/presigned-url)
...
📄 \*Doc. Cegedim : \*\*\*[_Object Storage — Vue générale_](https://academy.cegedim.cloud/storage/object-storage)
...
📄 \*Doc. Cegedim : \*\*\*[_Gérer les Object Users_](https://academy.cegedim.cloud/storage/object-storage/object-storage-get-started/manage-object-users)
...
📄 _Doc. Cegedim :_ \*[**Limitations et bonnes pratiques**](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/limitation-and-best-practices)\*\* · \*\*\*[_Object Lock_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/object-lock)
...
📄 \*Doc. Cegedim : \*\*\*[_Limitations et bonnes pratiques_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/limitation-and-best-practices)
...
📄 _Doc. Cegedim :_ \*[**Compatibilité API S3**](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/s3-api-compatibility)\*\* · \*\*\*[_Limitations et bonnes pratiques_](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/limitation-and-best-practices)
...
📄 _Doc. Cegedim :_ [_**Versioning**_](https://academy.cegedim.cloud/storage/object-storage/object-storage-get-started/manage-versioning-in-bucket)_\*\* ·_ \*[**Lifecycle**](https://academy.cegedim.cloud/storage/object-storage/object-storage-features/bucket-lifecycle)\*\* · \*\*\*[_Accès bucket_](https://academy.cegedim.cloud/storage/object-storage/object-storage-get-started/manage-bucket-access)
